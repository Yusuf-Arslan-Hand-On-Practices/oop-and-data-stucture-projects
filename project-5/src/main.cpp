...
int main() {
    ...
    add_activity(root, 1200, "eat");
    add_activity(root, 1000, "work");
    add_activity(root, 1300, "work");
    add_activity(root, 900, "eat");
    add_activity(root, 1100, "meet");
    add_activity(root, 1500, "eat");
    add_activity(root, 1030, "dance");
    add_activity(root, 1130, "walk");
