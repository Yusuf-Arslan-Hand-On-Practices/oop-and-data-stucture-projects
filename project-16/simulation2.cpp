...
void simulateBaristas(int currentBarista, Queue& baristaQueue, Queue& finishedQueue)
{
    ...
    if (baristaQueueCounter > maxBaristaQueueArr[currentBarista])
    {
        maxBaristaQueueArr[currentBarista] = baristaQueueCounter;
        baristaQueueCounter = 0;
    }
}
...
void simulation2(ifstream &inputFile, ofstream &outputFile)
{
    ...
    maxBaristaQueueArr = new int[numBaristas];
    // Fill maxBaristaQueueArr with 0
    for (int i = 0; i < numBaristas; i++)
    {
        maxBaristaQueueArr[i] = 0;
    }
    ...
    for (int i = 0; i < numBaristas; i++)
    {
        outputFile << maxBaristaQueueArr[i] << endl;
    }
